...
read -p "Enter IP for this data node: " ip_for_this_node
read -p "Enter Gateway for this data node: " gateway_for_this_node
read -p "Enter Netmask for this data node: " netmask_for_this_node
read -p "Enter Netmask for this data node: " ip_for_name_node
...
wget https://raw.githubusercontent.com/ChristianHenrikReich/automation-scripts/master/centos-minimal/etc/hadoop/data-node/core-site.xml -O /home/hadoop/hadoop/etc/hadoop/core-site.xml

echo -e "\e[32mUpdating hdfs-site.xml\e[39m"
wget https://raw.githubusercontent.com/ChristianHenrikReich/automation-scripts/master/centos-minimal/etc/hadoop/data-node/hdfs-site.xml -O /home/hadoop/hadoop/etc/hadoop/hdfs-site.xml

echo -e "\e[32mUpdating mapred-site.xml\e[39m"
wget https://raw.githubusercontent.com/ChristianHenrikReich/automation-scripts/master/centos-minimal/etc/hadoop/data-node/mapred-site.xml -O /home/hadoop/hadoop/etc/hadoop/mapred-site.xml

echo -e "\e[32mUpdating yarn-site.xml \e[39m"
wget https://raw.githubusercontent.com/ChristianHenrikReich/automation-scripts/master/centos-minimal/etc/hadoop/data-node/yarn-site.xml -O /home/hadoop/hadoop/etc/hadoop/yarn-site.xml 
...
sed -i -e "s/%%NameNodeIp%%/$ip_for_name_node/g" /home/hadoop/hadoop/etc/hadoop/hdfs-site.xml
sed -i -e "s/%%NameNodeIp%%/$ip_for_name_node/g" /home/hadoop/hadoop/etc/hadoop/core-site.xml
sed -i -e "s/%%NameNodeIp%%/$ip_for_name_node/g" /home/hadoop/hadoop/etc/hadoop/yarn-site.xml
